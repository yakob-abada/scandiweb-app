...
class ProductList extends React.Component<{}, stateType> {
    ...
    render () {
        return (
            <>
                <Button className='spaceButton spaceRight' href="/product-add">Add</Button>
                <Button className='spaceButton' onClick={this.deleteProducts}>Delete Selected Product(s)</Button>
